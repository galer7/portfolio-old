---
title: "The current state of grooming"
publishedAt: "19.11.2022"
description: "Problem I faced while participating in a grooming meeting"
cover: grooming.webp
coverAlt: Image of team showing thumbs up
---
...
3. While searching on the internet, I've found an asynchronous way for the grooming meeting, detailed [here](https://backstage.payfit.com/asynchronous-backlog-grooming/), where the process is moved to a Slack channel, and each member thinks of the problem on their own.